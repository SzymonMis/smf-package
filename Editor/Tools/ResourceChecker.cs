...
namespace SMF.Editor.Tools
{
	...
	public class TextureDetails : IEquatable<TextureDetails>
	{
		...
		public override int GetHashCode() => (int)texture.GetNativeTexturePtr();

		public override bool Equals(object obj) => Equals(obj as TextureDetails);
	};
	...
	public class MeshDetails
	{
		...
		public MeshDetails() => instance = false;
	};
	...
	public class ResourceChecker : EditorWindow
	{
		...
		[MenuItem("SMF Tools/Resource Checker")]
		static void Init()
		{
