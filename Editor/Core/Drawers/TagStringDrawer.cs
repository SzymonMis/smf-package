...
{ 
	public class TagStringDrawer : OdinAttributeDrawer<TagAttribute, string>
	{
		...
		private void UpdateButtonContent() => m_buttonContent.text = ValueEntry.SmartValue;
	...
	public abstract class TagStringListBaseDrawer<T> : OdinAttributeDrawer<TagAttribute, T> where T : IList<string>
	{
		...
		private void UpdateButtonContent() => m_buttonContent.text = m_buttonContent.tooltip = string.Join(", ", ValueEntry.SmartValue);
