	...
	public class ValueTracker : OdinEditorWindow
	{
		...
		private static void OnPropertyContextMenu()
		{
			EditorApplication.contextualPropertyMenu += (menu, property) =>
			{
				...
				menu.AddItem(new GUIContent("Track"), false, () =>
				{
					ShowMenu();
		...
		protected override void OnGUI()
		{
			...
			{
				EditorGUILayout.LabelField("Right-click any property in an Inspector and select 'Track' to make it show up here.", SirenixGUIStyles.MultiLineCenteredLabel);
			}
		...
		private class TreeValuesHolder
		{
			...
			{
				if (Tree == null || /*Tree.SecretRootProperty*/ Tree.RootProperty == null || Target == null)
				{
